...
**Site Reliability Engineer** | ByteDance | *Mar 2025 – Present* 
...
**System Engineer** | Tokopedia | *Mar 2021 – Mar 2025*  
...
**Cloud**: AWS, GCP, Alibaba Cloud, ByteCloud, DigitalOcean <br>
**IaC**: Terraform, Ansible, Packer, Helm <br>
**Containers**: Kubernetes, Docker <br>
**Observability**: Prometheus, Grafana, ELK, NewRelic <br>
**CI/CD**: Jenkins, GitLab, ArgoCD, GitHub Actions <br>
**Languages**: Go, Python, Bash <br>
**Data**: BigQuery, ClickHouse, PostgreSQL, MySQL, Redis <br>

## Education
**B.A.S. in Information Technology** | State Polytechnic of Jember | *2015 – 2019*
